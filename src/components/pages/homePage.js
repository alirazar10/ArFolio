export default function HomePage(){
    return(
        <div className="flex justify-center items-center w-full h-screen">
            <div className="relative overflow-hidden rounded-xl py-5 lg:p-0 w-full">
                <div className={`h-[160px] w-[150px] mx-auto lg:mx-0 lg:h-[320px] lg:w-[290px] rounded-xl border border-accent-700 overflow-hidden z-10 relative bg-background bg-cover bg-center`} >
                    {/* <Image src={MyImage} height={"100%"} width={"100%"} className="object-fill" alt="My image" /> */}
                </div>
                <div className="h-[280px] lg:h-[230px] bg-secondary-500 relative -mt-20 lg:mt-0 border border-primary-700 lg:absolute lg:top-[50%]  lg:-translate-y-2/4 lg:left-48 lg:tr flex flex-col justify-center items-stretch rounded-xl shadow-primary">
                    <div className="mx-2 px-2 pt-24 lg:p-0 lg:pr-5 space-y-2 lg:pl-[7rem] relative">
