...
export default function HomePage(){
    return(
        <div className="min-h-screen px-3 lg:px-6 flex justify-center items-center w-full">
            <div className="relative overflow-hidden rounded-xl p-5 lg:p-0 w-full">
                <div className="h-[150px] w-[150px] mx-auto lg:mx-0 lg:h-[330px] lg:w-[330px] rounded-full border border-accent-700 overflow-hidden z-10 relative">
                    <Image src={MyImage} height={"100%"} width={"100%"} alt="My image" />
                </div>
                <div className="lg:h-[230px] bg-secondary-500 relative -mt-20 lg:mt-0 border border-primary-700 lg:absolute lg:top-[50%]  lg:-translate-y-2/4 lg:left-48 lg:tr flex flex-col justify-center items-stretch rounded-xl shadow-primary">
                    <div className="mx-2 p-2 pt-24 lg:p-0 space-y-2 lg:pl-48 relative">
