...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center max-w-3xl mx-auto">
            ...
            <div className="mt-3 flex flex-col justify-end items-end">
              ...
              {state.succeeded && (
                <p className="text-primary-50 text-justify text-xs leading-6 py-3">
                  ...
                  sent and I&lsquo;ll get back to you as soon as possible. In
                  the meantime, why don&lsquo;t we plan to meet over a cup of
                  coffee? My treat!
                </p>
              )}
            </div>
      ...
      <div className="mt-10">
        <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-primary-50 py-2">
