...
export default function SocialMediaMetaTags () {
    ...
    return ( 
        <>
            ...
            <meta name="google-site-verification" content={`${baseUrl}/google1ecc11e592c8c73a.html`}/>
            <meta name="keywords" content="Full Stack Developer, Next.js React.js, JavaScript, PHP, Laravel, Python, Flask, TailwindCSS, CSS, HTML, Developer, " />
            ...
            <meta property={`og:image`} content={baseUrl+META_TAGS.facebook.image}/>
