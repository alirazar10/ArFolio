...
export const skills: Skill[] = [
  ...
  { name: "React.js", rate: 5 },
  { name: "Next.js", rate: 5 },
  { name: "TailwindCSS", rate: 5 },
  { name: "Material UI (MUI)", rate: 4 },
  ...
  { name: "Flask", rate: 4 },
  { name: "MySQL", rate: 5 },
  { name: "PostgreSQL", rate: 4 },
  { name: "MS SQL Server", rate: 3 },
  { name: "Flutter", rate: 3 },
  { name: "Strapi", rate: 4 },
  { name: "REST API", rate: 5 },
  { name: "Docker", rate: 3 },
  { name: "Git & GitHub", rate: 5 },
  { name: "SEO", rate: 3 },
  { name: "Adobe XD", rate: 4 },
  { name: "Figma", rate: 4 },
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description:
      "Full-stack developer specializing in modern web technologies. Building scalable applications with Next.js, React, and TypeScript on the frontend, and Node.js/Laravel on the backend. Experienced with Strapi CMS, TailwindCSS, Material UI, and cloud deployment. Focusing on pixel-perfect UI/UX and performance optimization.",
    skills: [
      "TypeScript",
      "Next.js",
      "React.js",
